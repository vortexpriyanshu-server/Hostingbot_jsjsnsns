...
COMMAND_BUTTONS_LAYOUT_USER_SPEC = [
    ["📢 ᴊᴏɪɴ ᴜᴩᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ"],
    ["📤 ᴜᴩʟᴏᴀᴅ ꜰɪʟᴇ", "📂 ᴄʜᴇᴄᴋ ꜰɪʟᴇꜱ"],
    ["⚡ ʙᴏᴛ ꜱᴩᴇᴇᴅ", "📊 ꜱᴛᴀᴛɪꜱᴛɪᴄꜱ"], # Statistics button kept for users, logic will restrict if not admin
    ["📞 ᴄᴏɴᴛᴀᴄᴛ ᴏᴡɴᴇʀ"]
]
ADMIN_COMMAND_BUTTONS_LAYOUT_USER_SPEC = [
    ["📢 ᴊᴏɪɴ ᴜᴩᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ"],
    ["📤 ᴜᴩʟᴏᴀᴅ ꜰɪʟᴇ", "📂 ᴄʜᴇᴄᴋ ꜰɪʟᴇꜱ"],
    ["⚡ ʙᴏᴛ ꜱᴩᴇᴇᴅ", "📊 ꜱᴛᴀᴛɪꜱᴛɪᴄꜱ"],
    ["💳 ꜱᴜʙꜱᴄʀɪᴩᴛɪᴏɴꜱ", "📢 ʙʀᴏᴀᴅᴄᴀꜱᴛ"],
    ["🔒 ʟᴏᴄᴋ ʙᴏᴛ", "🟢 ʀᴜɴɴɪɴɢ ᴀʟʟ ᴄᴏᴅᴇ"], # Changed "Free Mode" to "Running All Code"
    ["👑 ᴀᴅᴍɪɴ ᴩᴀɴᴇʟ", "📞 ᴄᴏɴᴛᴀᴄᴛ ᴏᴡɴᴇʀ"]
]
...
def create_main_menu_inline(user_id):
    ...
    buttons = [
        types.InlineKeyboardButton('📢 ᴊᴏɪɴ ᴜᴩᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ', url=UPDATE_CHANNEL, style='success'),
        types.InlineKeyboardButton('📤 ᴜᴩʟᴏᴀᴅ ꜰɪʟᴇ', callback_data='upload', style='primary'),
        types.InlineKeyboardButton('📂 ᴄʜᴇᴄᴋ ꜰɪʟᴇꜱ', callback_data='check_files', style='success'),
        types.InlineKeyboardButton('⚡ ʙᴏᴛ ꜱᴩᴇᴇᴅ', callback_data='speed', style='primary'),
        types.InlineKeyboardButton('📞 ᴄᴏɴᴛᴀᴄᴛ ᴏᴡɴᴇʀ', url=f'https://t.me/{YOUR_USERNAME.replace("@", "")}', style='danger')
    ]
    ...
    if user_id in admin_ids:
        admin_buttons = [
            ...
            types.InlineKeyboardButton('📢 ʙʀᴏᴀᴅᴄᴀꜱᴛ', callback_data='broadcast', style='danger'), #3
            types.InlineKeyboardButton('👑 ᴀᴅᴍɪɴ ᴩᴀɴᴇʟ', callback_data='admin_panel', style='success'), #4
...
def _logic_send_welcome(message):
    ...
    welcome_msg_text = (f"〽️ ᴡᴇʟᴄᴏᴍᴇ, {user_name}!\n\n🆔 ʏᴏᴜʀ ᴜꜱᴇʀ ɪᴅ: `{user_id}`\n"
                        f"✳️ ᴜꜱᴇʀɴᴀᴍᴇ: `@{user_username or 'Not set'}`\n"
                        f"🔰 ʏᴏᴜʀ ꜱᴛᴀᴛᴜꜱ: {user_status}{expiry_info}\n"
                        f"📁 ꜰɪʟᴇꜱ ᴜᴩʟᴏᴀᴅᴇᴅ: {current_files} / {limit_str}\n\n"
                        f"🤖 ʜᴏꜱᴛ & ʀᴜɴ ᴩʏᴛʜᴏɴ (`.py`) ᴏʀ ᴊꜱ (`.js`) ꜱᴄʀɪᴩᴛꜱ.\n"
                        f"   ᴜᴩʟᴏᴀᴅ ꜱɪɴɢʟᴇ ꜱᴄʀɪᴩᴛꜱ ᴏʀ `.zip` ᴀʀᴄʜɪᴠᴇꜱ.\n\n"
                        f"👇 ᴜꜱᴇ ʙᴜᴛᴛᴏɴꜱ ᴏʀ ᴛʏᴩᴇ ᴄᴏᴍᴍᴀɴᴅꜱ.")
...
def _logic_updates_channel(message):
    ...
    markup.add(types.InlineKeyboardButton('📢 ᴊᴏɪɴ ᴜᴩᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ', url=UPDATE_CHANNEL, style='success'))
    bot.reply_to(message, "ᴊᴏɪɴ ᴏᴜʀ ᴜᴩᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ:", reply_markup=markup)
...
def _logic_contact_owner(message):
    markup = types.InlineKeyboardMarkup()
    markup.add(types.InlineKeyboardButton('📞 ᴄᴏɴᴛᴀᴄᴛ ᴏᴡɴᴇʀ', url=f'https://t.me/{YOUR_USERNAME.replace("@", "")}', style='danger'))
...
BUTTON_TEXT_TO_LOGIC = {
    "📢 ᴊᴏɪɴ ᴜᴩᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ": _logic_updates_channel,
    "📤 ᴜᴩʟᴏᴀᴅ ꜰɪʟᴇ": _logic_upload_file,
    "📂 ᴄʜᴇᴄᴋ ꜰɪʟᴇꜱ": _logic_check_files,
    "⚡ ʙᴏᴛ ꜱᴩᴇᴇᴅ": _logic_bot_speed,
    "📞 ᴄᴏɴᴛᴀᴄᴛ ᴏᴡɴᴇʀ": _logic_contact_owner,
    "📊 ꜱᴛᴀᴛɪꜱᴛɪᴄꜱ": _logic_statistics,
    "💳 ꜱᴜʙꜱᴄʀɪᴩᴛɪᴏɴꜱ": _logic_subscriptions_panel,
    "📢 ʙʀᴏᴀᴅᴄᴀꜱᴛ": _logic_broadcast_init,
    "🔒 ʟᴏᴄᴋ ʙᴏᴛ": _logic_toggle_lock_bot,
    "🟢 ʀᴜɴɴɪɴɢ ᴀʟʟ ᴄᴏᴅᴇ": _logic_run_all_scripts,
    "👑 ᴀᴅᴍɪɴ ᴩᴀɴᴇʟ": _logic_admin_panel,
}
