...
def create_main_menu_inline(user_id):
    ...
    if user_id in admin_ids:
        admin_buttons = [
            types.InlineKeyboardButton('💳 Subscriptions', callback_data='subscription', style='primary'), #0
            types.InlineKeyboardButton('📊 Statistics', callback_data='stats', style='primary'), #1
            ...
            types.InlineKeyboardButton('📢 Broadcast', callback_data='broadcast', style='primary'), #3
            types.InlineKeyboardButton('👑 Admin Panel', callback_data='admin_panel', style='primary'), #4
            types.InlineKeyboardButton('🟢 Run All User Scripts', callback_data='run_all_scripts', style='success') #5
        ]
        ...
        markup.add(types.InlineKeyboardButton('📊 Statistics', callback_data='stats', style='primary')) # Allow non-admins to see stats too
...
def create_reply_keyboard_main_menu(user_id):
    ...
    for row_buttons_text in layout_to_use:
        markup.add(*[types.KeyboardButton(text, style='primary') for text in row_buttons_text])
    return markup
...
def create_control_buttons(script_owner_id, file_name, is_running=True): # Parameter renamed
    ...
    if is_running:
        markup.row(
            ...
            types.InlineKeyboardButton("🔄 Restart", callback_data=f'restart_{script_owner_id}_{file_name}', style='success')
        )
        markup.row(
